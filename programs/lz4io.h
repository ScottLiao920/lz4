...
int
LZ4IO_compressMultipleFilenames(const char **inFileNamesTable, int ifntSize, const char *suffix, int compressionlevel,
                                const LZ4IO_prefs_t *prefs);
...
typedef enum {
    LZ4IO_blockLinked = 0, LZ4IO_blockIndependent
} LZ4IO_blockMode_t;
